...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        privateCheckBox.setText("Private Check-in (Do not share with friends)");
        privateCheckBox.setToolTipText("Check this to perform a private check-in that does not notify your friends.");
    ...
    private void clearPrefs() {
        ...
        try {
            // Get the prefs safely, a few things can go wrong, don't blow up.
        ...
        try{
            ...
            prefs.remove(Main.PRIVATE_PREF_KEY);
        } catch(Exception e) {
            // no-op
        }
    }
    ...
    private void loadPrefs() {
        ...
        try {
            ...
            privateCheckBox.setSelected(prefs.getBoolean(Main.PRIVATE_PREF_KEY, true));
        } catch(Exception e) {
            // no-op
        }
    }
    ...
    private void storePrefs() {
        ...
        try {
            ...
            prefs.putBoolean(Main.PRIVATE_PREF_KEY, privateCheckBox.isSelected());
    ...
    private void checkInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkInButtonActionPerformed
        ...
        updateStatusDisplay("Storing preferences...", DEFAULT_STATUS_COLOR);
        
        // Store prefs for use later
        storePrefs();
        ...
        updateStatusDisplay("Connecting to foursquare API...", DEFAULT_STATUS_COLOR);
